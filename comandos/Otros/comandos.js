...
const moreDetails = new Discord.ActionRowBuilder().addComponents(new Discord.ButtonBuilder().setCustomId('moreDetails').setLabel('Más detalles').setStyle('PRIMARY'));
const lessDetails = new Discord.ActionRowBuilder().addComponents(new Discord.ButtonBuilder().setCustomId('lessDetails').setLabel('Menos detalles').setStyle('PRIMARY'));
const chooseOption = new Discord.ActionRowBuilder().addComponents(new Discord.StringSelectMenuBuilder().setCustomId('chooseOption').setPlaceholder('Seleccionar detalles forzados.').addOptions([
    {
...
module.exports = {
    ...
    run: async (client, message, args, _guild) => {
        ...
        let embed1 = new Discord.EmbedBuilder().setColor(user.premium.isActive? 0xffe76c : 0x0056ff).setDescription('' + LANG.commands.others.comandos.message1 +' `' + _guild.configuration.prefix + 'biblioteca`, ' + LANG.commands.others.comandos.message2 +' `' + _guild.configuration.prefix + 'invite`.\n' + LANG.commands.others.comandos.message3 +' (`[2]`) ' + LANG.commands.others.comandos.message4 +'.')
        .addFields({ name: `${user.premium.isActive? '<:proteccion_premium:880843689369423912>' : '<:proteccion:780163156902543370>'} | Protección:`, value: '`antiraid`, `antibots`, `antitokens`, `antijoins`, `mark-malicious`, `warn-entry`, `kick-malicious`, `ownsystem`, `verification`, `cannot-enter-twice`, `intelligentsos`, `purge-webhooks-attacks`, `intelligentAntiflood`, `antiflood`, `2fa [2]`, `raidmode`, `bloqEntritiesByName`, `bloqNewCreatedUsers`, `status`, `autoconfig`' })
        .addFields({ name: `${user.premium.isActive? '<:mod_premium:880843615809716245>' : '<:mod:780163163421278228>'} | Moderación:`, value: '`warn`, `unwarn`, `warnlist`, `forcereason [3]`, `kick`, `ban`, `unban`, `hackban`, `tempban`, `baninfo`, `mute`, `unmute`, `muteinfo`, `timeout`, `untimeout`, `forceban`, `detect`, `clear`, `nuke`, `support [3]`, `badword [3]`, `manyPings`, `manyEmojis`, `manyWords`, `capitalLetters`, `linkDetect`, `ghostping`, `automoderator`, `backup [5]`, `message`, `lock`, `unlock`, `nsfwFilter`, `predict`, `iploggerFilter`' })
        .addFields({ name: `${user.premium.isActive? '<:config_premium:880843546536579093>' : '<:config:780163162993328138>'} | Configuración`, value: '`setprefix`, `ignoreThisChannel`, `setmuterole`, `unnuke [4]`, `ping`, `whitelist [3]`, `logs [2]`, `guild [4]`, `member [4]`, `channel [2]`, `verify`, `editPingReply`' })
        .addFields({ name: `${user.premium.isActive? '<:otros_premium:880843655064191096>' : '<:otros:780163159553605653>'} | Otros`, value: '`comandos`, `biblioteca`, `me`, `staff`, `apelar`, `ayuda`, `invite`, `queja`, `reporte`, `sugerencia`, `bug`, `perfil`, `rz`' })
        ...
        let embed2 = new Discord.EmbedBuilder().setColor(0x0056ff).setDescription('' + LANG.commands.others.comandos.message1 +' `' + _guild.configuration.prefix + 'biblioteca`, ' + LANG.commands.others.comandos.message2 +' `' + _guild.configuration.prefix + 'invite`.\n' + LANG.commands.others.comandos.message3 +' (`[2]`) ' + LANG.commands.others.comandos.message4 +'.')
        .addFields({ name: `${user.premium.isActive? '<:proteccion_premium:880843689369423912>' : '<:proteccion:780163156902543370>'} | Protección:`, value: '`antiraid`, `antibots`, `antitokens`, `antijoins`, `mark-malicious`, `warn-entry`, `kick-malicious`, `ownsystem`, `verification`, `cannot-enter-twice`, `intelligentsos`, `purge-webhooks-attacks`, `intelligentAntiflood`, `antiflood`, `2fa [enable, disable]`, `raidmode`, `bloqEntritiesByName`, `bloqNewCreatedUsers`, `status`, `autoconfig`' })
        .addFields({ name: `${user.premium.isActive? '<:mod_premium:880843615809716245>' : '<:mod:780163163421278228>'} | Moderación:`, value: '`warn`, `unwarn`, `warnlist`, `forcereason [add, remove, clearAll]`, `kick`, `ban`, `unban`, `hackban`, `tempban`, `baninfo`, `mute`, `unmute`, `muteinfo`, `timeout`, `untimeout`, `forceban`, `detect`, `clear`, `nuke`, `support [sos, contact, server]`, `badword [add, remove, clearAll]`, `manyPings`, `manyEmojis`, `manyWords`, `capitalLetters`, `linkDetect`, `ghostping`, `automoderator`, `backup [create, delete, update, load, info]`, `message`, `lock`, `unlock`, `nsfwFilter`, `predict`, `iploggerFilter`' })
        .addFields({ name: `${user.premium.isActive? '<:config_premium:880843546536579093>' : '<:config:780163162993328138>'} | Configuración`, value: '`setprefix`, `ignoreThisChannel`, `setmuterole`, `unnuke [channels, roles, emojis, bans]`, `ping`, `whitelist [add, remove, clearAll]`, `logs [enable, disable]`, `guild [createInvite, setName, setIcon, info]`, `member [setnickname, removeRole, addRole, info]`, `channel [create, delete]`, `verify`, `editPingReply`' })
        .addFields({ name: `${user.premium.isActive? '<:otros_premium:880843655064191096>' : '<:otros:780163159553605653>'} | Otros`, value: '`comandos`, `biblioteca`, `me`, `staff`, `apelar`, `ayuda`, `invite`, `queja`, `reporte`, `sugerencia`, `bug`, `perfil`, `rz`' })
        .setImage(user.premium.isActive? 'https://cdn.discordapp.com/attachments/814538439243333632/880546149335957504/ethansita.png' : 'https://cdn.discordapp.com/attachments/779807899492417538/779820352817332264/unknown.png')
